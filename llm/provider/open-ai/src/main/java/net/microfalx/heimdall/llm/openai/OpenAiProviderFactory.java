...
public class OpenAiProviderFactory implements Provider.Factory {
    ...
    private void registerModels(net.microfalx.heimdall.llm.api.Provider.Builder builder) {
        ...
        builder.model((Model.Builder) Model.create("gpt-4.1 mini", "GPT-4.1 mini")).tag("openai").tag("gpt").tag("4.1 mini");
        builder.model((Model.Builder) Model.create("gpt-4o mini", "GPT-4o mini")).tag("openai").tag("gpt").tag("4o mini");
        builder.model((Model.Builder) Model.create("gpt-4.1 nano", "GPT-4.1 nano")).tag("openai").tag("gpt").tag("4.1 nao");
    }
}
